...
//    DispatchQueue.main.asyncAfter(deadline: .now() + seconds) {
    ...
    newView.myLabel?.text = "Testing swift label for custome view Testing swift label for custome view Testing swift label for custome view Testing swift label for custome view Testing swift label for custome view Testing swift label for custome view Testing swift label for custome view Testing swift label for custome view Testing swift label for custome view Testing swift label for custome "
